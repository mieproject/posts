...
<script>
    ...
    (function($) {
        document.head.insertAdjacentHTML("beforeend", `<style>.tagsinput,.tagsinput *{box-sizing:border-box}
...
.tagsinput div input::-moz-placeholder{color:#ccc;opacity:1}
.tagsinput div input:-ms-input-placeholder{color:#ccc;opacity:1}</style>`)
        var delimiter = [];
        var inputSettings = [];
        var callbacks = [];
